...
import { Globe, Search, Map, ChefHat } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-midnight/70 bg-midnight/80 border-b border-white/10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <Link to="/" className="flex items-center gap-2 text-silver hover:text-white transition-colors">
          ...
          <nav className="hidden md:flex items-center gap-6 text-silver">
            ...
            <Link to="/world" className="hover:text-white transition-colors flex items-center gap-1"><Map className="h-4 w-4"/>World Cuisines</Link>
            <a href="/#categories" className="hover:text-white transition-colors">Categories</a>
            <Link to="/calculator" className="hover:text-white transition-colors">Ingredient Calculator</Link>
            <Link to="/pantry" className="hover:text-white transition-colors">What Can I Make?</Link>
